...
import PostDetailModal from "@/src/components/home/PostDetailModal";

export default function Home() {
  const { loading, error, posts, getPosts, canLoadMore, reactPost, currentPost, handleClickPost } = usePost();
              ...
              <>
                {posts.map((post) => (
                  <Post
                    ...
                    onComment={() => handleClickPost(post.id, true)}
                  />
                ))}
